...
?>	
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Not Yet Claimed</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
							<table width="100%">
								<tr>
									<td align="left">
<form method="post" action="index.php?body=report4_dbase&mytag=POST">
From (m/d/y)
...
?>
							<table>
								<tr>
									<td align="left">
<form method="post" action="body_report4_excel.php?myid=myid<?php print($mypage); ?>&ulexcel=EXCEL" target="_blank">
...
<form method="post" action="body_report4_print.php?myid=myid<?php print($mypage); ?>&ulprint=PRINT" target="_blank">
