...
function IP_gridReadWrite(IP_grid_config,IP_grid_arr,IP_jsonObj,divID){
    ...
    for( var data in IP_grid_arr[0]) {
                            ...
                            IP_html += "<td id='"+IP_fieldname+"_"+primary_key_value+"_"+getUID+"'>" + eval("IP_jsonObj[j]." + IP_fieldname) + "</td>";
                            }catch(err){
                                IP_html += "<td><input type='button' name='btnEdit' id='IP_btn_edit_"+primary_key_value+"_"+getUID+"' value='Edit' onclick=IP_editrow('"+primary_key_value+"_"+getUID+"','"+editablefield+"','"+primary_key+"','"+primary_key_value+"','"+saveURL+"')><input type='button' name='btnDelete' id='IP_btn_delete_"+primary_key_value+"_"+getUID+"' value='Del' onclick=IP_deleterow('"+primary_key_value+"_"+getUID+"','"+editablefield+"','"+primary_key+"','"+primary_key_value+"','"+deleteURL+"')></td></td>";    
                            }
                        }
                        IP_html += "</tr>";
                    }
            ...
            var editfield = 'var arr = editablefield.split(","); for(var st in arr){ IP_persistValue[0][arr[st]+"_"+uid]=document.getElementById(arr[st]+"_"+uid+"").innerHTML; document.getElementById(arr[st]+"_"+uid+"").innerHTML="<input type=text id=edited_"+arr[st]+"_"+uid+" value=\'"+document.getElementById(arr[st]+"_"+uid+"").innerHTML+"\' >"} document.getElementById("IP_btn_edit_"+uid).value="Save";document.getElementById("IP_btn_delete_"+uid).value="Undo"; document.getElementById("IP_btn_edit_"+uid).onclick = function(){ IP_saverow(uid,editablefield,primary_key,primary_key_value,saveURL); } ;document.getElementById("IP_btn_delete_"+uid).onclick = function(){ IP_undorow(uid,editablefield,primary_key,primary_key_value,saveURL); } ;';
            ...
            var savefield = 'var querystring="";var arr = editablefield.split(","); for(var st in arr){ var edited_value = document.getElementById("edited_"+arr[st]+"_"+uid+"").value; querystring+="&"+arr[st]+"="+edited_value; document.getElementById(arr[st]+"_"+uid+"").innerHTML=edited_value} document.getElementById("IP_btn_edit_"+uid).value="Edit";document.getElementById("IP_btn_delete_"+uid).value="Del"; document.getElementById("IP_btn_edit_"+uid).onclick = function(){ IP_editrow(uid,editablefield,primary_key,primary_key_value,saveURL); }; IP_callURL(saveURL+"?"+primary_key+"="+primary_key_value+"&"+querystring,"","html",IP_onSaved); document.getElementById("IP_btn_delete_"+uid).onclick = function(){ IP_deleterow(uid,editablefield,primary_key,primary_key_value,saveURL); } ;';
            var deleterow = 'if(confirm("Are you sure you want to delete this?")){ IP_callURL(deleteURL+"?"+primary_key+"="+primary_key_value,"","html",IP_onDeleted); };';
...
function IP_callURL(URL, arrPost, responseType, func) {
    var allowAjaxCall=true;
    var xmlhttp = false;
    if (window.XMLHttpRequest)
    {/* code for IE7+, Firefox, Chrome, Opera, Safari*/
