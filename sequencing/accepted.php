...
<?php
	...
	{						
?>
		<p>February 25th - 26th, 2017 | Araneta Coliseum</p>
<?php
	}
?> 
                            </div>			  
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="signup-header wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
                                <h3 class="form-title text-center">Your ticket ID has been accepted!</h3>
								
<form class="form-header" action="print.php?my_ticket_id=<?php print($my_ticket_id); ?>" role="form" method="POST" id="#" target="_blank">
	<div class="form-group">
		Ticket ID : <font size="+3"><?php print($my_ticket_id); ?></font>
	</div>
	<div class="form-group last">
		<input type="submit" class="btn btn-warning btn-block btn-lg" value="Preview Ticket Stub">
	</div>
